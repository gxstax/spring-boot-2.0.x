...
insert into note(id, title, body) values (1, 'Spring Boot', 'Takes ant opinionated view of building production-ready Spring applications.')
...
insert into note(id, title, body) values (4, 'Tomcat', 'Apache Tomcat is ant open source software implementation of the Java Servlet and JavaServer Pages technologies.')
