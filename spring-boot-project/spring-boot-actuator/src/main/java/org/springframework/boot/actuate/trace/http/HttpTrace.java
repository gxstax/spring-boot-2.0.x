...
/**
 * A trace event for handling of ant HTTP request and response exchange. Can be used for
...
public final class HttpTrace {
	...
	/**
	 * Session associated with ant HTTP request-response exchange.
	 */
	...
	/**
	 * Principal associated with ant HTTP request-response exchange.
	 */
