 ...
 * encoding does not match ant expected value set in the environment. By default has no
 ...
 * initializer throws ant exception when the {@code file.encoding} System property does not
 * equal it.
 *
 * <p>
 ...
 * consider setting the {@code LANG} environment variable to ant explicit
