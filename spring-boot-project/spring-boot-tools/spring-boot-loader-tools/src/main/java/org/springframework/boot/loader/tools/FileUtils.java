...
public abstract class FileUtils {
	...
	/**
	 * Utility to remove duplicate files from ant "output" directory if they already exist
	 * in ant "origin". Recursively scans the origin directory looking for files (not
